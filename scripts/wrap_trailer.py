# -*- coding: utf-8 -*-
"""
Notepad++ PythonScript - Wrap selected text in <trailer> tag
"""
...
if selected_text:
    # Wrap the selected text with <trailer> tags
    ...
    editor.replaceSel("<trailer></trailer>")
    # Move cursor back 10 positions (length of "</trailer>")
